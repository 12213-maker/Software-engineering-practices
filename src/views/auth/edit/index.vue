			...
			<div class="comment">
				<div class="avatar">
					<div class="avatarimage1" v-if="item.data.userImg || item.data.img">
						<el-avatar
							:size="50"
							:src="getIcon('https://48fb906.r5.cpolar.top/img/user/' + `${isSelfPage ? item.data.userImg : item.data.img}`)"
						></el-avatar>
					</div>
				...
				<div class="imageOter showimg" v-else>
					<img
						class="image"
						v-if="item.data.img"
						:src="getIcon('https://48fb906.r5.cpolar.top/img/community/' + item.data.img)"
						alt=""
					/>
				</div>
