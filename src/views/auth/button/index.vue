				...
				<div class="comment" @click="changerouter(item)" v-infinite-scroll="load" v-for="item in showData.data" :key="item.img">
					<div class="avatar">
						<div class="avatarimage1" v-if="item.userImg">
							<el-avatar :size="50" :src="getIcon(' http://127.0.0.1:8080/img/user/' + item.userImg)"></el-avatar>
						</div>
					...
					<div class="imageOter" v-if="item.img">
						<img class="image" :src="getIcon(' http://127.0.0.1:8080/img/getselfcommunity/' + item.img)" alt="" />
					</div>
				...
				<div class="selfinformation">
					<el-card shadow="always">
						<div class="avatar">
							<el-avatar
								:size="120"
								:src="getIcon(' http://127.0.0.1:8080/img/user/' + globalStore.userInformation.img)"
							></el-avatar>
						</div>
