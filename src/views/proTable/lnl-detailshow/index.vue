			...
			<div class="container">
				<el-carousel class="carousel">
					<el-carousel-item class="carouselItem" v-for="picture in dataValue.data.placePictures" :key="picture">
						<img :src="getIcon('https://48fb906.r5.cpolar.top/img/place/' + picture)" alt="" />
					</el-carousel-item>
				</el-carousel>
				<div class="describe">
				...
				<div class="comment" v-infinite-scroll="load" v-for="item in dataValue.commentData" :key="item.id">
					<div class="avatar">
						<div class="avatarimage1" v-if="item.userImg">
							<el-avatar :size="50" :src="getIcon('https://48fb906.r5.cpolar.top/img/user/' + item.userImg)" />
						</div>
					...
					<div class="imageOter">
						<img
							...
							class="image"
							:key="picture"
							:src="getIcon('https://48fb906.r5.cpolar.top/img/comment/' + picture)"
							alt=""
						/>
					</div>
