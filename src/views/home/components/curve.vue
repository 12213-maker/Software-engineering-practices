...
const initChart = (data: any) => {
	...
	const option = {
      ...
      color:#fff; background: #6B9DFE;border-radius: 4px;font-size:14px; ">
        ...
        <div style="display: flex;align-items: center;"><div style="width:5px;height:5px;background:#ffffff;border-radius: 50%;margin-right:5px"></div>数据量（万人次） :  ${p[0].value}</div>
      </div>`;
				return dom;
			}
		},
